...
playstore <- na.omit(playstore)
playstore$Android.Ver <- as.numeric(substr(playstore$Android.Ver,start=1,stop=3))

# Convert Reviews, Rating, Price, Installs to numeric
...
playstore$Type[is.nan(playstore$Type)] <- NA
playstore <- na.omit(playstore)
